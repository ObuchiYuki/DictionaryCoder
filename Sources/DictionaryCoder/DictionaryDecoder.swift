//===----------------------------------------------------------------------===//
//
// This source file is largely a copy of code from Swift.org public source project's
...
public class DictionaryDecoder {
    ...
    public var missingValueDecodingStrategy : MissingValueDecodingStrategy = .`throw`
    ...
    public func decode<T : Decodable>(_ type: T.Type, from dictionary: NSDictionary) throws -> T {
